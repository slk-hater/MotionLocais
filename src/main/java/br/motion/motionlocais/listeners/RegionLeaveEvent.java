...
public class RegionLeaveEvent implements Listener {
    @EventHandler(priority = EventPriority.NORMAL)
    public void onRegionLeaveEvent(com.mewin.WGRegionEvents.events.RegionLeaveEvent e) {
